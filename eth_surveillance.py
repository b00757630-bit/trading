# -*- coding: utf-8 -*-
"""
Surveillance ETH/USDT (4H) - API publique Binance via CCXT.
Stratégie :
...
def main_loop(interval_seconds: int = 4 * 3600) -> None:
    ...
    """
    # logger.info("Démarrage surveillance ETH/USDT (4H) - intervalle %s s", interval_seconds)
    # while True:
    try:
        run_cycle()
    except Exception as e:
